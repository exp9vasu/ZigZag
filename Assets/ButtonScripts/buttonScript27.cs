...
public class buttonScript27 : MonoBehaviour
{
	...
	void TaskOnClick()
	{
		...
		if (mcount >= 500)
		{
			PlayerPrefs.SetInt("bb", 28);
			buttonOff.SetActive(false);
			buttonOn.SetActive(true);
			PlayerPrefs.SetInt("bmat", 28);

			mcount = mcount - 500;
			PlayerPrefs.SetInt("count", mcount);
			PlayerPrefs.SetInt("shop", 27);
