...
public class buttonScript25 : MonoBehaviour
{
	...
	void TaskOnClick()
	{
		...
		if (mcount >= 500)
		{
			PlayerPrefs.SetInt("z", 26);
			buttonOff.SetActive(false);
			buttonOn.SetActive(true);
			PlayerPrefs.SetInt("bmat", 26);

			mcount = mcount - 500;
			PlayerPrefs.SetInt("count", mcount);
			PlayerPrefs.SetInt("shop", 25);
