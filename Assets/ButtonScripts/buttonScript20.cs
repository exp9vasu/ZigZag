...
public class buttonScript20 : MonoBehaviour
{
	...
	void TaskOnClick()
	{
		...
		if (mcount >= 500)
		{
			PlayerPrefs.SetInt("u", 21);
			buttonOff.SetActive(false);
			buttonOn.SetActive(true);
			PlayerPrefs.SetInt("bmat", 21);

			mcount = mcount - 500;
			PlayerPrefs.SetInt("count", mcount);
			PlayerPrefs.SetInt("shop", 20);
