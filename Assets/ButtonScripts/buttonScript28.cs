...
public class buttonScript28 : MonoBehaviour
{
	...
	void TaskOnClick()
	{
		...
		if (mcount >= 500)
		{
			PlayerPrefs.SetInt("cc", 29);
			buttonOff.SetActive(false);
			buttonOn.SetActive(true);
			PlayerPrefs.SetInt("bmat", 29);

			mcount = mcount - 500;
			PlayerPrefs.SetInt("count", mcount);
			PlayerPrefs.SetInt("shop", 28);
