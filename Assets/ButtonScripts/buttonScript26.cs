...
public class buttonScript26 : MonoBehaviour
{
	...
	void TaskOnClick()
	{
		...
		if (mcount >= 500)
		{
			PlayerPrefs.SetInt("aa", 27);
			buttonOff.SetActive(false);
			buttonOn.SetActive(true);
			PlayerPrefs.SetInt("bmat", 27);

			mcount = mcount - 500;
			PlayerPrefs.SetInt("count", mcount);
			PlayerPrefs.SetInt("shop", 26);
